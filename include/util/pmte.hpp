...
struct pmte_value : detail::base {
  ...
  private:
...
#if __cplusplus >= CPP17_STANDARD
    template <std::size_t I = 0, typename R, typename Types, typename std::enable_if_t<std::is_pointer<typename std::tuple_element_t<I, Types>>::value> * = nullptr>
    R get_if_() noexcept;
    ...
    template <std::size_t I = 0, typename R, typename Types,
      typename std::enable_if_t<I<std::tuple_size<Types>::value - 1 && std::is_pointer<typename std::tuple_element_t<I, Types>>::value> * = nullptr> R get_if_() noexcept;

    template <std::size_t I = 0, typename R, typename Types, typename std::enable_if_t<I == std::tuple_size<Types>::value - 1 && std::is_pointer<typename std::tuple_element_t<I, Types>>::value> * = nullptr>
    R get_if_() noexcept;
    ...
    template <std::size_t I = 0, typename R, typename Types,
      typename std::enable_if_t<I<std::tuple_size<Types>::value - 1 && std::is_pointer<typename std::tuple_element_t<I, Types>>::value> * = nullptr> R get_if_() const noexcept;
...
template <typename T>
struct value_store<T, typename std::enable_if_t<std::is_integral<T>::value || std::is_floating_point<T>::value || std::is_enum<T>::value || std::is_null_pointer<T>::value>> : pmte_value {
    ...
    NO_DISCARD CPP20_CONSTEXPR PURE_FUNC HOT_FUNC FLATTEN bool is_castable_to(type_base const & other_type) const noexcept override { return index(other_type) >= 0; }

    std::ostream & print(std::ostream & out) const override { return print_impl<T>(out); }

    enum : bool { has_deleter = false, is_copy_constructible = true, is_move_constructible = true, is_copy_assignable = true, is_move_assignable = true };
...
template <typename T>
CPP14_CONSTEXPR const type_info<T> value_store<T, typename std::enable_if_t<std::is_integral<T>::value || std::is_floating_point<T>::value || std::is_enum<T>::value || std::is_null_pointer<T>::value>>::info;
...
struct value_store<T, typename std::enable_if<std::is_pointer<T>::value>::type> : pmte_value {
    ...
    NO_DISCARD CPP20_CONSTEXPR PURE_FUNC HOT_FUNC FLATTEN bool is_castable_to(const type_base & other_type) const noexcept override { return index(other_type) >= 0; }
...
template <typename T>
struct value_store<T, typename std::enable_if_t<!std::is_abstract<T>::value && (std::is_class<T>::value || std::is_union<T>::value)>> : pmte_value {
    static_assert(!std::is_volatile<T>::value, "'volatile' is not supported");
    static_assert(std::is_nothrow_destructible<T>::value, "T can't have a throwing destructor!");
    static_assert(
      !std::is_default_constructible<T>::value ? std::is_move_constructible<T>::value || std::is_copy_constructible<T>::value || std::is_move_assignable<T>::value || std::is_copy_assignable<T>::value : true,
    ...
    FORCE_INLINE constexpr explicit value_store(U && content) noexcept(std::is_nothrow_move_constructible<std::remove_reference_t<U>>::value) : value(std::forward<U>(content)) {}

    template <typename U,
      typename std::enable_if_t<std::is_move_constructible<std::remove_reference_t<U>>::value && std::is_lvalue_reference<U>::value && std::is_copy_constructible<std::remove_reference_t<U>>::value> * = nullptr>
    FORCE_INLINE constexpr explicit value_store(U && content) noexcept(std::is_nothrow_move_constructible<std::remove_reference_t<U>>::value) : value(content) {}

    template <typename U,
      typename std::enable_if_t<std::is_default_constructible<std::remove_reference_t<U>>::value && std::is_move_assignable<std::remove_reference_t<U>>::value &&
        !std::is_move_constructible<std::remove_reference_t<U>>::value> * = nullptr>
    FORCE_INLINE constexpr explicit value_store(U && content) noexcept(std::is_nothrow_move_assignable<std::remove_reference_t<U>>::value) : value() {
    ...
    template <typename U, typename std::enable_if_t<std::is_default_constructible<U>::value && std::is_copy_assignable<U>::value && !std::is_copy_constructible<U>::value> * = nullptr>
    FORCE_INLINE constexpr explicit value_store(U const & content) noexcept(std::is_nothrow_default_constructible<U>::value && std::is_nothrow_copy_assignable<U>::value) : value() {
        value = content;
    }
...
template <typename T>
CPP14_CONSTEXPR const type_info<T> value_store<T, typename std::enable_if<!std::is_abstract<T>::value && (std::is_class<T>::value || std::is_union<T>::value)>::type>::info;
...
struct rtti : Base {
    ...
    NO_DISCARD CPP20_CONSTEXPR PURE_FUNC type_base type() const noexcept override final { return type_info<std::tuple_element_t<0, std::tuple<Ts...>>> {}; }

    NO_DISCARD CPP20_CONSTEXPR PURE_FUNC HOT_FUNC FLATTEN int index(type_base const & other_type) const noexcept override { return index_of_type(other_type); }

    NO_DISCARD CPP20_CONSTEXPR PURE_FUNC HOT_FUNC FLATTEN bool is_castable_to(const type_base & other_type) const noexcept override final { return index(other_type) >= 0; }
...
struct deleter : Base {
  ...
  public:
    ...
    FORCE_INLINE deleter(T && p_, Func && f_) noexcept(noexcept(std::forward<Func>(f_))) : Base(std::forward<T>(p_)), f(std::forward<Func>(f_)), owner(true) {}
    ...
    deleter(deleter && other) noexcept(noexcept(std::is_nothrow_move_constructible<Func>::value)) : Base(std::forward<deleter>(other)), f(std::move(other.f)), owner(other.owner) {
        other.owner = false;
    }

    template <typename U, std::enable_if_t<Base::is_copy_constructible> * = nullptr>
    deleter(deleter const & other) noexcept(noexcept(std::is_nothrow_copy_constructible<Func>::value)) : Base(other), f(other.f), owner(false) {}
...
struct anchor final : Base {
  ...
  private:
    ...
    template <typename T = Base>
    NO_DISCARD typename std::enable_if_t<T::has_deleter && T::is_copy_assignable && !T::is_copy_constructible, pmte_value *> clone_impl(void * address) const;
...
template <typename Base>
template <typename T>
NO_DISCARD typename std::enable_if_t<T::has_deleter && T::is_copy_assignable && !T::is_copy_constructible, pmte_value *> anchor<Base>::clone_impl(void * address) const {
    if (address == nullptr) address = operator new(sizeof(anchor));
...
struct handler_specific final : handler_typed<T> {
    ...
    std::ostream & print(std::ostream & out) const override { return out << "{hash:" << get_hash_code(type_info<T> {}) << ",type:\"" << type_name<T>() << "\",func:" << type_name<Func>() << '}'; }
...
#else
template <std::size_t I, typename R, typename Types, typename std::enable_if_t<I<std::tuple_size<Types>::value - 1 && std::is_pointer<typename std::tuple_element_t<I, Types>>::value> *> R pmte_value::get_if_() noexcept {
    using T = std::tuple_element_t<I, Types>;
    if (is_castable_to(type_info<T> {})) {
        return static_cast<detail::value_store<std::remove_const_t<T>> *>(this)->get();
    }
...
template <std::size_t I, typename R, typename Types, typename std::enable_if_t<I == std::tuple_size<Types>::value - 1 && std::is_pointer<typename std::tuple_element_t<I, Types>>::value> *>
R pmte_value::get_if_() noexcept {
    using T = std::tuple_element_t<I, Types>;
    if (is_castable_to(type_info<T> {})) {
        return static_cast<detail::value_store<std::remove_const_t<T>> *>(this)->get();
...
template <std::size_t I, typename R, typename Types,
  typename std::enable_if_t<I<std::tuple_size<Types>::value - 1 && !std::is_pointer<typename std::tuple_element_t<I, Types>>::value> *> R * pmte_value::get_if_() noexcept {
    using T = std::tuple_element_t<I, Types>;
    if (is_castable_to(type_info<T> {})) {
        return static_cast<R *>(raw_access());
    }
...
#else
template <std::size_t I, typename R, typename Types,
  typename std::enable_if_t<I<std::tuple_size<Types>::value - 1 && std::is_pointer<typename std::tuple_element_t<I, Types>>::value> *> R pmte_value::get_if_() const noexcept {
    using T = std::tuple_element_t<I, Types>;
    if (is_castable_to(type_info<const T> {})) {
        return static_cast<const detail::value_store<T> *>(this)->get();
    }
...
template <typename RefType, typename std::enable_if_t<std::is_integral<RefType>::value || std::is_floating_point<RefType>::value || std::is_enum<RefType>::value || std::is_null_pointer<RefType>::value> * = nullptr>
...
NO_DISCARD auto make_unique_pmte(std::pmr::memory_resource & resource, ArgType && v_ = RefType {}) noexcept(false) {
    ...
    return std::unique_ptr<object_type, decltype(resource_deleter)>(construct_pmte_at<RefType>(resource.allocate(sizeof(object_type)), std::forward<T>(v_)), std::move(resource_deleter));
}
...
template <typename RefType = void, typename ArgType, typename std::enable_if_t<std::is_pointer<util::remove_cvref_t<ArgType>>::value && std::is_void<RefType>::value> * = nullptr>
NO_DISCARD constexpr inline auto build_pmte(ArgType && v_) noexcept(false) {
...
NO_DISCARD auto make_unique_pmte(std::pmr::memory_resource & resource, ArgType && v_) noexcept(false) {
    ...
    return std::unique_ptr<object_type, decltype(resource_deleter)>(construct_pmte_at<RefType>(resource.allocate(sizeof(object_type)), std::forward<ArgType>(v_)), std::move(resource_deleter));
}
...
NO_DISCARD constexpr inline auto build_pmte(ArgType && v_, type_list<Types...>) noexcept(false) {
    static_assert(std::is_void<RefType>::value || std::is_convertible<ArgType, RefType>::value, "ArgType must be convertible to RefType for pointer types");
    ...
    using object_type = detail::anchor<detail::rtti<detail::value_store<T>, T, util::add_const_on_pointer_t<T>, Types..., util::add_const_on_pointer_t<Types>..., void *, const void *>>;
...
NO_DISCARD auto make_unique_pmte(std::pmr::memory_resource & resource, ArgType && v_, type_list<Types...>) noexcept(false) {
    ...
    return std::unique_ptr<object_type, decltype(resource_deleter)>(construct_pmte_at<RefType>(resource.allocate(sizeof(object_type)), std::forward<ArgType>(v_), type_list<Types...> {}),
...
template <typename RefType = void, typename ArgType, typename Deleter,
  typename std::enable_if_t<std::is_pointer<ArgType>::value && util::is_invocable<Deleter, typename std::conditional_t<std::is_void<RefType>::value, ArgType, RefType>>::value> * = nullptr>
...
template <typename RefType = void, typename ArgType, typename Deleter,
  typename std::enable_if_t<std::is_pointer<ArgType>::value && util::is_invocable<Deleter, typename std::conditional<std::is_void<RefType>::value, ArgType, RefType>::type>::value> * = nullptr>
...
NO_DISCARD auto make_unique_pmte(std::pmr::memory_resource & resource, ArgType && v_, Deleter && d_) noexcept(false) {
    ...
    return std::unique_ptr<object_type, decltype(resource_deleter)>(construct_pmte_at<RefType>(resource.allocate(sizeof(object_type)), std::forward<ArgType>(v_), std::forward<Deleter>(d_)),
      std::move(resource_deleter));
}
...
NO_DISCARD auto make_shared_pmte(std::pmr::memory_resource & resource, ArgType && v_, Deleter && d_) noexcept(false) {
    static_assert(std::is_void<RefType>::value || std::is_convertible<ArgType, RefType>::value, "ArgType must be convertible to RefType for pointer types");
    using object_type = decltype(build_pmte<RefType>(std::forward<ArgType>(v_), std::forward<Deleter>(d_)));
    return std::allocate_shared<object_type>(std::pmr::polymorphic_allocator<object_type>(&resource), std::forward<ArgType>(v_), std::forward<Deleter>(d_));
}
#endif
...
NO_DISCARD constexpr inline auto build_pmte(ArgType && v_, Deleter && d_, type_list<Types...>) noexcept(false) {
    ...
    using T = typename std::conditional<std::is_void<RefType>::value, ArgType, RefType>::type;
    using object_type = detail::anchor<detail::deleter<detail::rtti<detail::value_store<T>, T, util::add_const_on_pointer_t<T>, Types..., util::add_const_on_pointer_t<Types>..., void *, const void *>, Deleter, T>>;
...
NO_DISCARD auto make_unique_pmte(ArgType && v_, Deleter && d_, type_list<Types...>) noexcept(false) {
    static_assert(is_convertible<ArgType>::template to<Types...>::value, "ArgType must be a convertible to provided types!");
    using object_type = decltype(build_pmte<RefType>(std::forward<ArgType>(v_), std::forward<Deleter>(d_), type_list<Types...> {}));
    return std::unique_ptr<object_type>(construct_pmte_at<RefType>(operator new(sizeof(object_type)), std::forward<ArgType>(v_), std::forward<Deleter>(d_), type_list<Types...> {}));
}
...
NO_DISCARD auto make_shared_pmte(ArgType && v_, Deleter && d_, type_list<Types...>) noexcept(false) {
    ...
    static_assert(is_convertible<ArgType>::template to<Types...>::value, "ArgType must be a convertible to provided types!");
    using object_type = decltype(build_pmte<RefType>(std::forward<ArgType>(v_), std::forward<Deleter>(d_), type_list<Types...> {}));
    return std::shared_ptr<object_type>(construct_pmte_at<RefType>(operator new(sizeof(object_type)), std::forward<ArgType>(v_), std::forward<Deleter>(d_), type_list<Types...> {}));
}
...
NO_DISCARD auto make_pmte(std::pmr::memory_resource & resource, ArgType && v_, Deleter && d_, type_list<Types...>) noexcept(false) {
    ...
    static_assert(is_convertible<ArgType>::template to<Types...>::value, "ArgType must be a convertible to provided types!");
    using object_type = decltype(build_pmte<RefType>(std::forward<ArgType>(v_), std::forward<Deleter>(d_), type_list<Types...> {}));
    return construct_pmte_at<RefType>(resource.allocate(sizeof(object_type)), std::forward<ArgType>(v_), std::forward<Deleter>(d_), type_list<Types...> {});
}
...
NO_DISCARD auto make_unique_pmte(std::pmr::memory_resource & resource, ArgType && v_, Deleter && d_, type_list<Types...>) noexcept(false) {
    ...
    return std::unique_ptr<object_type, decltype(resource_deleter)>(
      construct_pmte_at<RefType>(resource.allocate(sizeof(object_type)), std::forward<ArgType>(v_), std::forward<Deleter>(d_), type_list<Types...> {}), std::move(resource_deleter));
}
...
template <typename RefType, typename std::enable_if_t<(std::is_class<RefType>::value || std::is_union<RefType>::value) && std::is_default_constructible<RefType>::value> * = nullptr>
NO_DISCARD constexpr inline auto build_pmte() noexcept(false) {
#if __cplusplus <= CPP14_STANDARD
    static_assert(std::is_const<RefType>::value ? std::is_copy_constructible<RefType>::value : true, "const values must be copyable under C++14 or lower!");
    static_assert(std::is_move_constructible<RefType>::value || std::is_copy_constructible<RefType>::value, "RefType must be movable and/or copyable!");
#endif
    using object_type = detail::anchor<detail::value_store<RefType>>;
    return object_type();
}
...
template <typename RefType = void, typename ArgType,
  typename std::enable_if_t<(std::is_class<ArgType>::value || std::is_union<ArgType>::value) && (std::is_void<RefType>::value || std::is_same<RefType, ArgType>::value)> * = nullptr>
NO_DISCARD constexpr inline auto build_pmte(ArgType && v_) noexcept(false) {
    static_assert(std::is_const<ArgType>::value ? std::is_copy_constructible<ArgType>::value || std::is_copy_assignable<ArgType>::value : true, "ArgType needs to be copyable for const rvalues!");
    static_assert(std::is_move_constructible<ArgType>::value || std::is_move_assignable<ArgType>::value || std::is_copy_constructible<ArgType>::value || std::is_copy_assignable<ArgType>::value,
...
template <typename RefType = void, typename ArgType,
  typename std::enable_if_t<(std::is_class<ArgType>::value || std::is_union<ArgType>::value) && (std::is_void<RefType>::value || std::is_same<RefType, ArgType>::value)> * = nullptr>
NO_DISCARD constexpr inline auto build_pmte(ArgType & v_) noexcept(false) {
    static_assert(std::is_copy_constructible<ArgType>::value || std::is_copy_assignable<ArgType>::value, "ArgType needs to be copyable for lvalues!");
    using object_type = detail::anchor<detail::value_store<ArgType>>;
    return object_type(v_);
}
...
NO_DISCARD auto make_unique_pmte(std::pmr::memory_resource & resource, ArgType & v_) noexcept(false) {
    ...
    return std::unique_ptr<object_type, decltype(resource_deleter)>(construct_pmte_at<RefType>(resource.allocate(sizeof(object_type)), v_), std::move(resource_deleter));
}
...
template <typename RefType = void, typename ArgType, typename std::enable_if_t<std::is_class<ArgType>::value && !std::is_void<RefType>::value && !std::is_same<RefType, ArgType>::value> * = nullptr>
NO_DISCARD constexpr inline auto build_pmte(ArgType && v_) noexcept(false) {
...
NO_DISCARD constexpr inline auto build_pmte(ArgType && v_, type_list<Types...>) noexcept(false) {
    ...
    static_assert(std::is_const<ArgType>::value ? all_are_const<RefT, Types...>::value : true, "If ArgType is const all castable types must be const also!");
...
NO_DISCARD inline auto construct_pmte_at(void * address, ArgType && v_, type_list<Types...>) noexcept(false) {
    static_assert(std::is_void<RefType>::value || std::is_convertible<ArgType *, RefType *>::value, "ArgType must be convertible to RefType");
    static_assert(is_derived<ArgType>::template from<ArgType, Types...>::value, "ArgType must be a decendent from provided bases!");
    static_assert(std::is_const<ArgType>::value ? std::is_void<RefType>::value ? all_are_const<Types...>::value : all_are_const<RefType, Types...>::value : true,
...
NO_DISCARD auto make_unique_pmte(std::pmr::memory_resource & resource, ArgType & v_, type_list<Types...>) noexcept(false) {
    ...
    return std::unique_ptr<object_type>(construct_pmte_at<RefType>(resource.allocate(sizeof(object_type)), v_, type_list<Types...> {}), std::move(resource_deleter));
}
...
NO_DISCARD auto make_shared_pmte(std::pmr::memory_resource & resource, ArgType && v_, type_list<Types...>) noexcept(false) {
    ...
    static_assert(std::is_const<ArgType>::value ? std::is_copy_constructible<ArgType>::value || std::is_copy_assignable<ArgType>::value : true, "ArgType needs to be copyable for const rvalues!");
    using object_type = decltype(build_pmte<RefType>(std::forward<ArgType>(v_), type_list<Types...> {}));
    return std::allocate_shared<object_type>(std::pmr::polymorphic_allocator<object_type>(&resource), std::forward<ArgType>(v_), type_list<Types...> {});
}
...
class visitor_base {
  private:
    ...
    NO_DISCARD FORCE_INLINE constexpr static std::size_t calculate_index_in_of_hash_cache(std::size_t hash_code) { return (hash_code & mask) >> 8; }
  ...
  public:
    ...
    template <typename T, typename Func>
    self & add(Func && func) {
        static_assert(util::is_invocable<Func, T>::value || util::is_invocable<Func, std::add_lvalue_reference_t<T>>::value, "Provided handler must be invocable with provided type T");
...
#if __cplusplus >= CPP17_STANDARD
    pmte_visitor(Functions... functions) noexcept(std::is_nothrow_default_constructible<detail::visitor_base>::value) : visitor_base(), Functions(functions)... { register_(functions...); }
#else
